...
export const Dashboard: React.FC = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      setRecentMovements(movements.slice(0, 5)); // Solo los últimos 5
      setExpiringBatches(expiring.slice(0, 5)); // Solo los primeros 5
      setError('');
    } catch (err) {
  ...
  const recentMovementsColumns = [
    {
      ...
      render: (value: string) => (
        <div className="flex items-center space-x-2">
          ...
          <Badge variant={getMovementTypeColor(value) as any} size="sm">
        ...
        <Card className="border-l-4 border-l-blue-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-blue-600">{dashboardData?.totalProducts || 0}</p>
            </div>
        ...
        <Card className="border-l-4 border-l-green-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600">{dashboardData?.totalCategories || 0}</p>
            </div>
        ...
        <Card className="border-l-4 border-l-purple-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-purple-600">{dashboardData?.totalStores || 0}</p>
            </div>
        ...
        <Card className="border-l-4 border-l-red-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-red-600">{stockAlerts.length}</p>
            </div>
          ...
          <Link href="/inventory" className="block">
            <div className="p-4 border-2 border-black bg-green-500 text-white hover:bg-green-600 transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px]">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-bold">Control de Inventario</h3>
          ...
          <Link href="/alerts" className="block">
            <div className="p-4 border-2 border-black bg-orange-500 text-white hover:bg-orange-600 transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px]">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-bold">Ver Alertas</h3>
        ...
        <Card title="Resumen de Alertas de Stock" className="border-l-4 border-l-red-500">
          <div className="space-y-3">
            {stockAlerts.slice(0, 3).map((alert, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-red-50 border border-red-200">
                <div>
